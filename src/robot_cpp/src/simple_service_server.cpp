...
public:
    SimpleServiceServer() : Node("simple_service_server")
    {
        ...
        RCLCPP_INFO_STREAM(get_logger(), "Service add_two_ints");
    }
private:
    rclcpp::Service<robot_msgs::srv::AddTwoInts>::SharedPtr service_;
    void serviceCallback(std::shared_ptr<robot_msgs::srv::AddTwoInts::Request> req,
                         std::shared_ptr<robot_msgs::srv::AddTwoInts::Response> res)
    {
